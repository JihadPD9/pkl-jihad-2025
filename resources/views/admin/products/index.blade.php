                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center">
                                            @if($product->image)
                                                <img src="{{ Storage::url($product->image) }}" class="rounded me-2" width="40" height="40">
                                            @else
                                    ...
                                    <td class="text-center">
                                        <span class="badge bg-warning text-dark"> Rp {{ number_format($product->price, 0, ',', '.') }}</span>
                                    </td>
                                    <td class="text-center">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center py-4 text-muted">Belum ada Produk.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
